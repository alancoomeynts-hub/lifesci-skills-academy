...
-JS script to close menu after navigation was taken from Boardwalk Games Project code and modified by VS Code agent to fit project. My understanding is the provided code didn't work as it was designed to work on collapse navbars and not offcanvas drawers
